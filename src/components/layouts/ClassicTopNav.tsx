...
const ClassicTopNav = () => {
  ...
  return (
    <header className="flex items-center gap-tds-16 px-tds-24 py-tds-8 bg-white w-full h-[60px] relative z-10 shrink-0" style={{ boxShadow: '0px 1px 4px 0px rgba(0,0,0,0.12), 0px 1px 2px 0px rgba(0,0,0,0.05)' }}>
      <div className="flex items-center justify-between flex-1">
        <div className="flex items-center gap-tds-16">
          ...
          <div className="flex items-center gap-tds-6">
            <nav className="flex items-center gap-tds-6 text-[12px]">
              {isDashboard && <span className="text-tds-text-body-primary font-medium">Dashboard</span>}
              {isTicketList && (
                <>
            ...
            {isTicketDetails && (
              <button onClick={() => { navigator.clipboard.writeText(ticketId!); triggerToast('Ticket ID copied to clipboard'); }} className="text-tds-text-caption-secondary hover:text-tds-text-body-primary cursor-pointer p-[2px]" title="Copy ticket ID">
                <CopyIcon />
              </button>
            )}
          </div>
        ...
        <div className="flex items-center gap-tds-16">
          <div className="flex items-center h-[36px]">
            <button className="flex items-center gap-tds-4 px-tds-12 h-full border border-tds-border-neutral-primary rounded-l-tds-default bg-white cursor-pointer">
              <span className="text-[12px] font-medium text-tds-text-body-primary whitespace-nowrap">Ticket ID</span>
              <ChevronDownIcon />
            </button>
            <div className="flex items-center gap-tds-4 px-tds-12 h-full border border-tds-border-neutral-primary border-l-0 rounded-r-tds-default bg-white w-[280px]">
              <span className="text-tds-icon-body-primary"><SearchIcon /></span>
              <input type="text" placeholder="Search by ticket id" className="flex-1 text-[12px] font-medium text-tds-text-body-primary placeholder:text-tds-text-body-disabled outline-none bg-transparent" />
            </div>
          </div>
