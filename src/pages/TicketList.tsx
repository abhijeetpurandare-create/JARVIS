import { Pill, Button, TarmacTable, Pagination } from '@delhivery/tarmac';
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-hidden pr-tds-16 pb-tds-16 flex flex-col">
        <div className="border border-tds-border-neutral-primary rounded-tds-md overflow-hidden flex flex-col flex-1">
          ...
          {/* Pagination — TDS Component */}
          <div className="shrink-0 border-t border-tds-border-neutral-primary px-tds-16 py-tds-8">
            <Pagination
